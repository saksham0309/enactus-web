...
var event = [
  ...
  },
  {
    ...
    desc2:
      " Burmese refugees and transgender community, whose talents if shaped and guided well could give them a chance to stand on their feet and earn for themselves. We had to make sure that the products that we made would appeal to our target audience and therefore, it was essential that every piece was produced through our audiences’ lens. ",
    desc3:
      "The designs and cost analysis were done, keeping our audience in mind to ensure the success of our project.Our team came up with a system to collect the textile waste from industries, and old clothes from the local societies which could be used as raw materials to produce handmade recycled products, like bags, pouches etc.",
    desc4:
      "Our basic idea was to empower the ladies from the Chennai slums, the transgender community and the Rohingya refugees and distribute the profit amongst them. "
  },

  {
    ...
    desc1:
      "The project creates awareness on the methods to be taken up in disposal of the sanitary napkins and the safety measures.It focuses on biodegradable pads which is a hygienic practice and is also an environment friendly product.Project NAARI aims to provide HYGIENIC AND HEALTHY environment to people.",
    desc2:
      "THE NEED FOR NAARI: Menstrual hygiene and management is a very elementary knowledge that people need to have. Living in the 21st century where the world is heading with technology and modernisation, the taboo on menstruation still prevails and there are people who are still have not explored on what is the basic hygiene required for a healthy living. Thus, it is necessary for women to know and use hygienic as well as environment friendly methods during menstruation. NAARI is an initiative taken for this issue.",
    desc3:
      "PROJECT PARTNERS:We have collaborated with Ecofemme (A social enterprise by women that manufactures and sells cloth pads) and Myna Mahila (a foundation that aspires to empower women and end period poverty).",
    desc4: ""
  },
  {
    date: "26 july 2017",
